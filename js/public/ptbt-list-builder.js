...
jQuery(document).ready(function($){
	...
	var email_capture_url = wpajax_url + '?action=ptbt_save_subscription';
	
	$('form#ptbt_register_form').bind('submit',function(){
	...
	// email capture action url
	var unsubscribe_url = wpajax_url + '?action=ptbt_unsubscribe';
	
	$(document).on('submit','form#ptbt_manage_subscriptions_form',function(){
